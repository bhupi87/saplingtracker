...
import com.salah.projectmanager.repo.CommentRepository;
...
public class ManagerServiceImpl implements ManagerService {
    ...
    public void updateProject(Project project, String user) {
        ...
        if (project != null && p.getUsers().contains(userRepository.findByUsername(user))) {
            ...
            p.setFileInfo(project.getFileInfo());
	...
	@Override
	public List<Comment> getComments(int idT) {
		List<Comment> listComment=commentRepository.findByTaskId(idT);
		return listComment;
	}
